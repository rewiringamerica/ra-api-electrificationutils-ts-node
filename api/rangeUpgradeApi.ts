...
export class RangeUpgradeApi {
     ...
     */
    public async rangeUpgradeRangeUpgradeV1Get (currentFuel: RangeFuelType, occupants: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<EnergyTradeoff>;  }> {
        const localVarPath = this.basePath + '/range_upgrade/v1/';
        ...
        if (currentFuel === null || currentFuel === undefined) {
            throw new Error('Required parameter currentFuel was null or undefined when calling rangeUpgradeRangeUpgradeV1Get.');
        }

        // verify required parameter 'occupants' is not null or undefined
        if (occupants === null || occupants === undefined) {
            throw new Error('Required parameter occupants was null or undefined when calling rangeUpgradeRangeUpgradeV1Get.');
        }
